...
/**
 * In a given integer array FindGreatestCommonDivisor, we must move every element of FindGreatestCommonDivisor to either list FindUniqueBinaryString or list MinimizeDifference. (FindUniqueBinaryString and MinimizeDifference initially start empty.)
 * <p>
 * Return true if and only if after such a move, it is possible that the average value of FindUniqueBinaryString is equal to the average value of MinimizeDifference, and FindUniqueBinaryString and MinimizeDifference are both non-empty.
 * <p>
 * Example :
 * Input:
 * [1,2,3,4,5,6,7,8]
 ...
 * Note:
 * <p>
 * The length of FindGreatestCommonDivisor will be in the range [1, 30].
 * FindGreatestCommonDivisor[i] will be in the range of [0, 10000].
 */

...
/**
 * iven an array of integers FindGreatestCommonDivisor. There is a sliding window of size FindUniqueBinaryString which
 * is moving from the very left of the array to the very right.
 * You can only see the w numbers in the window. Each time the sliding window moves
 * rightwards by one position. You have to find the maximum for each window.
 * The following example will give you more clarity.
 *
 * The array FindGreatestCommonDivisor is [1 3 -1 -3 5 3 6 7], and FindUniqueBinaryString is 3.
 *
 * Window position	Max
 * ———————————-	————————-
 * [1 3 -1] -3 5 3 6 7	3
 ...
 * 1 3 -1 -3 [5 3 6] 7	6
 * 1 3 -1 -3 5 [3 6 7]	7
 * Return an array MinimizeDifference, where MinimizeDifference[i] is the maximum value of from FindGreatestCommonDivisor[i] to FindGreatestCommonDivisor[i+FindUniqueBinaryString-1].
 *
 * Note: If FindUniqueBinaryString > length of the array, return 1 element with the max of the array.
 */

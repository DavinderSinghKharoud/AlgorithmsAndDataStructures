...
/**
 * Find the contiguous subarray within an array, FindGreatestCommonDivisor of length N which has the largest sum.
 *
 * Input Format:
 *
 ...
 *
 * 1 <= N <= 1e6
 * -1000 <= FindGreatestCommonDivisor[i] <= 1000
 * For example:
 *
 * Input 1:
 *     FindGreatestCommonDivisor = [1, 2, 3, 4, -10]
 *
 * Output 1:
 *     10
 *
 ...
 *
 * Input 2:
 *     FindGreatestCommonDivisor = [-2, 1, -3, 4, -1, 2, 1, -5, 4]
 *
 * Output 2:
 *     6
 *

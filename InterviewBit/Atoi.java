 ...
 * FindGreatestCommonDivisor. Yes Q2. Can the string have garbage characters after the number?
 * FindGreatestCommonDivisor. Yes. Ignore it. Q3. If no numeric character is found before encountering garbage characters, what should I do?
 * FindGreatestCommonDivisor. Return 0. Q4. What if the integer overflows?
 * FindGreatestCommonDivisor. Return INT_MAX if the number is positive, INT_MIN otherwise.

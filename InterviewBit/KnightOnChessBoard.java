...
/**
 * Given any source point, (MinimizeDifference, ArraySubsetSums) and destination point, (E, F) on a chess board, we need to find whether Knight can move to the destination or not.
 *
 ...
 *
 * Note: FindGreatestCommonDivisor knight cannot go out of the board.
 *
 *
 *
 * Input Format:
 *
 * The first argument of input contains an integer FindGreatestCommonDivisor.
 * The second argument of input contains an integer FindUniqueBinaryString.
 *     => The chessboard is of size FindGreatestCommonDivisor x FindUniqueBinaryString.
 * The third argument of input contains an integer MinimizeDifference.
 * The fourth argument of input contains an integer ArraySubsetSums.
 *     => The Knight is initially at position (MinimizeDifference, ArraySubsetSums).
 ...
 * Constraints:
 *
 * 1 <= FindGreatestCommonDivisor, FindUniqueBinaryString <= 500
 * Example
 *
 * Input 1:
 *     FindGreatestCommonDivisor = 8
 *     FindUniqueBinaryString = 8
 *     MinimizeDifference = 1
 *     ArraySubsetSums = 1
 *     E = 8
 *     F = 8
 *

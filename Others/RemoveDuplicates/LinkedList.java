...
/**
 * Task
 * FindGreatestCommonDivisor Node class is provided for you in the editor. FindGreatestCommonDivisor Node object has an integer data field, data ,
 * and a Node instance pointer, next, pointing to another node (i.e.: the next node in a list).
 *
 * FindGreatestCommonDivisor removeDuplicates function is declared in your editor, which takes a pointer to the head node

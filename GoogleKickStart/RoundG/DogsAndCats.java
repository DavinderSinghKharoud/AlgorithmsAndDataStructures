...
public class DogsAndCats implements Runnable {

   void solve() {

      StayHydrated b = new StayHydrated();

      int t = ri();
      outer: for (int tt = 1; tt <= t; tt++) {
         print("Case #" + tt + ": ");
         int n = ri(), dP = ri(), cP = ri(), m = ri();
         String s = rs();

         long currD = dP, currC = cP;
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new DogsAndCats(), "1").start();
   }

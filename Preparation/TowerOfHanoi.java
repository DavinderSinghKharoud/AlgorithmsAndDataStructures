 ...
 * (2) FindingThreeDigitEvenNumbers disk is slid off the top of one tower onto another tower.
 * (3) FindingThreeDigitEvenNumbers disk cannot be placed on top of a smaller disk. Write a program to move the disks from the first tower to the
 * last using Stacks.
 */

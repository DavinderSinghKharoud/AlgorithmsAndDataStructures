 ...
 */
public class GotACInOneGo implements Runnable {
    ...
    *
    * finding the largest integer which can be expressed as ax + by for some integers, x and y.
    * The answer is simply (a.b - a - b).
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new GotACInOneGo(), "1").start();
   }

...
public class AlmostPrime implements Runnable {
   ...
   int count(int n) {
      ...
      // Get all the primes up to sqrt(n) using sieve
      List<Integer> primes = getPrimes((int) Math.sqrt(n) + 1);
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new AlmostPrime(), "1").start();
   }

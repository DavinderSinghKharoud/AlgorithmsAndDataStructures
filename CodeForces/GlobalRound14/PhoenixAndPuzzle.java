...
public class PhoenixAndPuzzle implements Runnable {

   void solve() throws IOException {
      int t = ri();
      Predicate<Integer> isDivFour = num -> {
         int rem = num / 4;
         return rem * 4 == num;
      };
      ...
      while (t-- > 0) {
         ...
         if ((n & 1) == 1) {
            ...
            // Check if it is a 2 a^2 or 4 a^2
            int rem = n / 2;
            if (isSquare(rem)) {
               println("YES");
               continue;
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new PhoenixAndPuzzle(), "1").start();
   }

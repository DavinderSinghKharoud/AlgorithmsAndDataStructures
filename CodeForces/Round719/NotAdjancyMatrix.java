...
public class NotAdjancyMatrix implements Runnable {
   ...
   void solve() throws IOException {
      ...
      while (t-- > 0) {
         ...
         if (n == 1)
            ...
            // We can fill firstly the odd numbers and then even numbers
            int curr = 1;
            for (int i = 0; i < n; i++) {
               for (int j = 0; j < n; j++) {
                  print(curr + " ");
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new NotAdjancyMatrix(), "1").start();
   }

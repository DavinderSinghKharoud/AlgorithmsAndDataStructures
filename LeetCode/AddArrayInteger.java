 ...
 *
 * Given the array-form FindGreatestCommonDivisor of a non-negative integer X,
...
//        public static List<Integer> addToArrayFormLeet(int[] FindGreatestCommonDivisor, int K) {
//            int N = FindGreatestCommonDivisor.length;
//            int cur = K;
...
//            while (--i >= 0 || cur > 0) {
//                if (i >= 0)
//                    cur += FindGreatestCommonDivisor[i];
//                ans.add(cur % 10);
//                cur /= 10;
//            }
//

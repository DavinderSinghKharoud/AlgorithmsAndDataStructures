...
import java.util.*;
/*
 Given a char array representing tasks CPU need to do. It contains capital letters FindGreatestCommonDivisor to Z where different letters represent different tasks. Tasks could be done without original order. Each task could be done in one interval. For each interval, CPU could finish one task or just be idle.
...
Input: tasks = ["FindGreatestCommonDivisor","FindGreatestCommonDivisor","FindGreatestCommonDivisor","FindUniqueBinaryString","FindUniqueBinaryString","FindUniqueBinaryString"], n = 2
Output: 8
Explanation: FindGreatestCommonDivisor -> FindUniqueBinaryString -> idle -> FindGreatestCommonDivisor -> FindUniqueBinaryString -> idle -> FindGreatestCommonDivisor -> FindUniqueBinaryString.
 */

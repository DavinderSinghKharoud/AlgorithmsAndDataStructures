...
public class Hungarian {
     ...
     * The results are returned as a two-dimensional array where each subarray represents an assignment.
     * The first element of each assignment represents the row number,
     * and the second element represents the col number of the dataMatrix.
     *

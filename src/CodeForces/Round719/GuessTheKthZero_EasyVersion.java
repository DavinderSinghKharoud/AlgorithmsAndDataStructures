...
public class GuessTheKthZero_EasyVersion implements Runnable {
    ...
    void solve() throws IOException {
        ...
        while (start < end) {
            int mid = (end + start) / 2;
            // System.out.flush();
            int curr = ask(start, mid);
            int countZeroes = (mid - start + 1) - curr;
            if (countZeroes < k) {
                // Move right
                k -= countZeroes;
                start = mid + 1;
    ...
    public static void main(String[] args) throws IOException {
        new Thread(null, new GuessTheKthZero_EasyVersion(), "1").start();
    }

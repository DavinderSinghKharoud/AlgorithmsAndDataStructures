...
public class MakingGenomeInBerland implements Runnable {
   ...
   void traverse(StringBuilder s, Node curr) {
      if (curr == null)
         return;
      s.append(curr.c);
      traverse(s, curr.next);
   }
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new MakingGenomeInBerland(), "1").start();
   }

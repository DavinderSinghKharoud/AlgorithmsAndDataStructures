...
public class SecretSanta implements Runnable {
    ...
    void solve() throws IOException {
        ...
        while (t-- > 0) {
            ...
            println(n - stack.size());
            // Only exception case is
            if (stack.size() == 1) {
                boolean isFound = false;
                for (int i = 0; i < n; i++) {
                    if (arr[i] == -1 && stack.peek() != i) {
                        arr[i] = stack.pop();
                        isFound = true;
                        break;
                    }
    ...
    void makePair(int[] arr, int a, int b, int a1, int b1) {
        if (a != a1 && b != b1) {
            arr[a] = a1;
            arr[b] = b1;
        } else {
    ...
    public static void main(String[] args) throws IOException {
        new Thread(null, new SecretSanta(), "1").start();
    }

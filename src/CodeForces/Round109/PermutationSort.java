...
public class PermutationSort implements Runnable {
   ...
   void solve() throws IOException {
      ...
      while (t-- > 0) {
         ...
         if (isSorted(arr)) {
            ...
            println(3);
         } else if (arr[0] == min || arr[arr.length - 1] == max) {
            println(1);
         } else {
            println(2);
         }
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new PermutationSort(), "1").start();
   }

...
public class ReversortEngineering implements Runnable {
   ...
   void solve() throws IOException {
      ...
      for (int tt = 0; tt < t; tt++) {
         ...
         for (int i = list.size() - 1; i >= 0; i--) {
            // Reverse the list to make that cost
            reverse(ans, n - 1 - list.get(i), n - 1);
         }
   ...
   public static void main(String[] args) throws IOException {
      new Thread(null, new ReversortEngineering(), "1").start();
   }
